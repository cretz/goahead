...
func (this *Object_fAFaMw_Í) HashCode_Gyq6fg_Í() int32 {
...
func (this *StringBuilder_UtRw1g_Í) Append_RGOMdA_Í(var1 int32) StringBuilder_UtRw1g_Ñ {
	this.Underlying += strconv.Itoa(int(var1))
	return this
}
...
func (this *System_hB0pIw_Ś) IdentityHashCode_lcJyvA_Í(var0 Object_fAFaMw_Ñ) int32 {
	if var0 == nil {
		return 0
	}
	// TODO: review
